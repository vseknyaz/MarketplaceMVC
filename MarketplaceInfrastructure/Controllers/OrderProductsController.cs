...
namespace MarketplaceInfrastructure.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public OrderProductsController(MarketplaceContext context)
        {
            _context = context;
        }
        ...
        {
            var marketplaceContext = _context.OrderProducts.Include(o => o.Order).Include(o => o.Product);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "CategoryId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,OrderId,ProductId,AdditionalInfo,Quantity")] OrderProduct orderProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderProductId,OrderId,ProductId,AdditionalInfo,Quantity")] OrderProduct orderProduct)
        {
