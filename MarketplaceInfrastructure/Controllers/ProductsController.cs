...
namespace MarketplaceInfrastructure.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var marketplaceContext = _context.Products.Include(p => p.Category).Include(p => p.Shop);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ShopId,CategoryId,ProductName,Description,Price,Stock")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ShopId,CategoryId,ProductName,Description,Price,Stock")] Product product)
        {
